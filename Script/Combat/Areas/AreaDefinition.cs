...
public class AreaDefinition
{
    ...
    public static string GetShortDescription(CombatAreaId areaId)
    {
        return areaId switch
        {
            ...
            CombatAreaId.Gen => "峦障：受到伤害减少10%；压顶：近战伤害+30%。",
    ...
    public static string GetEncyclopediaText(CombatAreaId areaId)
    {
        return areaId switch
        {
            ...
            CombatAreaId.Gen => "峦障：位于该区域时，受到伤害减少10%。压顶：近战攻击+30%伤害。离开该区域后，该加成可持续一次近战攻击。（如果是技能“阳巡八荒”这种多个时点的多次近战攻击，只对下一次生效，而非整个后续攻击）",
